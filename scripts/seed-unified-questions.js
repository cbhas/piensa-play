...
const unifiedQuestions = [
    ...
    // =========================================================================
    {
        ...
        content: '"Beber jugo de zanahoria da visión nocturna como los gatos en 30 días", según el Dr. Inventado de ElNoticiero.com',
        imageUrl: null,
        source: 'ElNoticiero.com',
        date: 'Publicado: Hoy',
        options: [
            { id: 'author', text: 'Autor no es un experto real', isCorrect: true, feedback: 'El "Dr. Inventado" no es verificable' },
            { id: 'source', text: 'Fuente no confiable', isCorrect: true, feedback: 'ElNoticiero.com no está verificado' },
            { id: 'image', text: 'Imagen manipulada', isCorrect: false, feedback: 'No hay imagen en esta noticia' },
            { id: 'data', text: 'Datos exagerados', isCorrect: true, feedback: '"Visión de gato en 30 días" es exagerado' },
        ],
        explanation: '¡Excelente! Las zanahorias ayudan a la vista pero no dan visión nocturna.',
        incorrectExplanation: 'El autor es inventado, la fuente no es confiable y los datos son exagerados.',
        order: 1,
    },
    {
        id: 'q2_vacunas',
        ...
        subtitle: 'Selecciona todos los elementos sospechosos',
        content: '¡URGENTE! Vacunas dan superpoderes a niños, según científicos anónimos. ¡Comparte antes de que lo borren!',
        imageUrl: null,
        source: 'NoticiasTotales.net',
        date: 'Hace 2 horas',
        options: [
            { id: 'author', text: 'Autor anónimo', isCorrect: true, feedback: 'Científicos anónimos no son verificables' },
            { id: 'source', text: 'Fuente no verificada', isCorrect: true, feedback: 'NoticiasTotales.net no es un medio reconocido' },
            { id: 'urgency', text: 'Presión para compartir', isCorrect: true, feedback: '"¡Comparte antes de que lo borren!" es manipulación' },
            { id: 'claim', text: 'Afirmación absurda', isCorrect: true, feedback: '"Superpoderes" es imposible' },
        ],
        explanation: '¡Perfecto! Todas las opciones son señales de desinformación.',
        incorrectExplanation: 'Usa autor anónimo, fuente no verificada, presión emocional y afirmaciones absurdas.',
        order: 2,
    },
    {
        id: 'q3_agua_mar',
        ...
        content: '"Médicos ocultan que el agua de mar cura cáncer y diabetes". La industria farmacéutica no quiere que sepas esto.',
        imageUrl: null,
        ...
        options: [
            ...
            { id: 'miracle', text: 'Cura milagrosa', isCorrect: true, feedback: 'Curar "todo" es imposible' },
            { id: 'source', text: 'Fuente no científica', isCorrect: true, feedback: 'Un blog no es fuente científica' },
            { id: 'evidence', text: 'Sin evidencia', isCorrect: true, feedback: 'No cita estudios reales' },
        ],
        explanation: '¡Excelente! Esta información es peligrosa: beber agua de mar es dañino.',
        incorrectExplanation: 'Usa conspiraciones, promete curas milagrosas sin evidencia. ¡Beber agua de mar es peligroso!',
        order: 3,
    },
    ...
    // =========================================================================
    {
        ...
        content: '¡CURA MÁGICA! El agua con limón ¡ELIMINA INSTANTÁNEAMENTE CUALQUIER VIRUS! ¡Comparte para proteger a tus amigos! 🍋',
        imageUrl: null,
        source: 'SaludTotal.com',
        date: 'Hace 2 horas',
        options: [
            { id: 'true', text: 'Verdadero', isCorrect: false, feedback: 'Las mayúsculas y promesas exageradas son señales de desinformación' },
            { id: 'false', text: 'Falso', isCorrect: true, feedback: 'El limón ayuda pero no "elimina virus instantáneamente"' },
        ],
        correctBoolAnswer: false,
        explanation: '¡Muy bien! Las mayúsculas y la presión para compartir son señales de desinformación.',
        incorrectExplanation: 'Es FALSA. Fíjate en las mayúsculas, la promesa exagerada y la presión para compartir.',
        order: 1,
    },
    {
        id: 'tf_q2',
        ...
        type: 'trueFalse',
        title: '¿Esta noticia es verdadera o falsa?',
        content: 'Estudio en "The Lancet" revela que 30 minutos de ejercicio diario mejora la salud cardiovascular, según la Universidad Nacional.',
        imageUrl: null,
        source: 'CienciaHoy.edu',
        date: 'Hace 1 día',
        options: [
            { id: 'true', text: 'Verdadero', isCorrect: true, feedback: 'Tiene fuentes verificables y lenguaje moderado' },
            { id: 'false', text: 'Falso', isCorrect: false, feedback: 'Esta noticia tiene características confiables' },
        ],
        correctBoolAnswer: true,
        explanation: '¡Excelente! Cita fuentes verificables (Universidad, The Lancet) y usa lenguaje profesional.',
        incorrectExplanation: 'Es VERDADERA. Cita fuentes verificables y usa datos específicos.',
        order: 2,
    },
    {
        id: 'tf_q3',
        ...
        type: 'trueFalse',
        title: '¿Esta noticia es verdadera o falsa?',
        content: '¡GOBIERNO OCULTA LA VERDAD! Las antenas 5G controlan nuestras mentes. ¡COMPARTE ANTES DE QUE LO BORREN! 👁️',
        imageUrl: null,
        source: 'NoticiasSinCensurar.net',
        date: 'Hace 3 horas',
        options: [
            { id: 'true', text: 'Verdadero', isCorrect: false, feedback: 'Tiene múltiples señales de desinformación' },
            { id: 'false', text: 'Falso', isCorrect: true, feedback: 'Es una teoría de conspiración sin fundamento' },
        ],
        correctBoolAnswer: false,
        explanation: '¡Perfecto! Es una conspiración FALSA. Las mayúsculas y la presión para compartir son señales claras.',
        incorrectExplanation: 'Es una teoría de conspiración FALSA. No hay evidencia científica.',
        order: 3,
    },

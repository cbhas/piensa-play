...
class CiberseguridadIntroPage extends StatelessWidget {
  ...
  const CiberseguridadIntroPage({super.key, required this.currentMission}); // Update constructor
      ...
      child: Row(
        ...
        children: [
          ...
          Container(
            ...
            child: const Text('🛡️', style: TextStyle(fontSize: 32)), // Emoji principal sugerido
          )
  ...
  Widget _buildHeroSection(Size size) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: const Color(0xFFFF6B6B).withOpacity(0.4), // Color principal sugerido
            blurRadius: 20,
  ...
  Widget _buildInstructionCards() {
    return Column(
      children: CiberseguridadQuizData.instructions.asMap().entries.map((entry) {
  ...
  Widget _buildStartButton(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: const LinearGradient(
          colors: [AppTheme.accentRed, Color(0xFFC62828)], // Usando accentRed
          begin: Alignment.topLeft,
          end: Alignment.bottomRight,
        ),

...
class AppStrings {
  ...
  static const Map<String, Map<String, String>> _values = {
    'es': {
      ...
      'levelCoins': 'Nivel {level} · {coins} monedas',
      'shop': 'Tienda',
      'classicMissions': 'Misiones clásicas',
      'classicMissionsSubtitle': 'Veracidadville, Zona Cero y Ciberseguridad',
      'overallProgress': 'Tu avance general',
    },
    'en': {
      'appName': 'PiensaPlay',
      ...
      'levelCoins': 'Level {level} · {coins} coins',
      'shop': 'Shop',
      'classicMissions': 'Classic missions',
      'classicMissionsSubtitle': 'Veracidadville, Zero Zone and Cybersecurity',
